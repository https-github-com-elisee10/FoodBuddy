...
public class DetailSearchActivity extends AppCompatActivity {
    ...
    TextView tvSearchTitle,tvSearchInstructions;
    ImageView ivDetailSearchImage;

    //url to get the information about the food with given id
    String SearchId;

    final String TAG = "DetailSearchActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivDetailSearchImage = findViewById(R.id.ivDetailSearchImage);
        tvSearchInstructions = findViewById(R.id.tvSearchInstructions);
//
//
...
//        tvDetail.setText("https://api.spoonacular.com/recipes/" + id + "/information");
        ...
        String URL_FETCH ="https://api.spoonacular.com/recipes/" + SearchId + "/information?includeNutrition=false&apiKey=7e4bf9cab7ab42b1aa7d886374bf0b51";
...
//                    Glide.with(this).load("http://i.imgur.com/DvpvklR.png").into(imageView);
                    ...
                    tvSearchInstructions.setText(instructions);
